...
def upgrade() -> None:
    ...
    op.add_column(
        "post_annotations", sa.Column("severity_level", sa.Integer(), nullable=True)
    )
    op.add_column(
        "post_annotations",
        sa.Column("misinformation_type", sa.String(length=50), nullable=True),
    ...
    op.add_column(
        "reddit_posts", sa.Column("code_switching_score", sa.Float(), nullable=True)
    )
    op.add_column(
        "reddit_posts", sa.Column("translation_patterns", sa.Boolean(), nullable=True)
    )
    op.add_column(
        "reddit_posts",
    ...
    op.add_column(
        "user_stats", sa.Column("community_expertise", sa.Text(), nullable=True)
    )
    op.add_column(
        "user_stats", sa.Column("language_communities", sa.Text(), nullable=True)
    )
    op.add_column(
        "user_stats", sa.Column("cultural_competency_score", sa.Float(), nullable=True)
    )
